...
| 43 | guitar-paired-chords-vector | 1/0 | 1/1 | 1 | C4 → D4 | 2 / 1 / 0 | treble | pdf-text-glyph | g_d15_f4 U+E0A4 black | 337.451,297.359 17.157×24.508 | 0.248737 → 0.243818 → factor 0.1373 | -2 → -2 | 0/1 | — | 0.92 | accidental_state (0.95) | accidental-error, ledger-line-ownership, wrong-staff-step-anchor |
| 44 | guitar-paired-chords-vector | 1/0 | 1/1 | 1 | E4 → G4 | 3 / 2 / 0 | treble | pdf-text-glyph | g_d15_f4 U+E0A4 black | 337.451,277.753 17.157×24.508 | 0.233586 → 0.230664 → factor 0.0106 | 0 → 0 | 0/0 | — | 0.92 | accidental_state (0.95) | accidental-error, wrong-staff-step-anchor |
| 45 | guitar-paired-chords-vector | 1/0 | 1/1 | 2 | D4 → C4 | -2 / -1 / 0 | treble | pdf-text-glyph | g_d15_f4 U+E0A4 black | 536.797,251.611 17.157×24.508 | 0.213384 → 0.210462 → factor -1.3927 | 4 → -1 | 0/0 | — | 0.92 | pitch_mapping (0.85) | wrong-staff-step-anchor |
| 46 | guitar-paired-chords-vector | 1/0 | 1/1 | 2 | G4 → A4 | 2 / 1 / 0 | treble | pdf-text-glyph | g_d15_f4 U+E0A4 black | 536.797,297.359 17.157×24.508 | 0.248737 → 0.243431 → factor 1.4839 | -2 → 2 | 0/1 | — | 0.92 | pitch_mapping (0.85) | ledger-line-ownership, wrong-staff-step-anchor |
| 47 | guitar-paired-chords-vector | 1/0 | 1/1 | 3 | A4 → G4 | -2 / -1 / 0 | treble | pdf-text-glyph | g_d15_f4 U+E0A4 black | 736.144,271.217 17.157×24.508 | 0.228535 → 0.223338 → factor 0.7538 | 2 → 3 | 0/0 | — | 0.92 | pitch_mapping (0.85) | wrong-staff-step-anchor |
