...
Generated: 2026-07-17T01:57:20.103Z
Fixtures: 1
Overall: FAIL
Largest remaining error bucket: chord = 58 (28%)
...
- Categories: scanned-score, grand-staff, ties-slurs-articulations, chords-multiple-voices
  pitch 30% | duration 49% | onset 54% | chord 54% | F1 82%
  measureΔ 0 | noteΔ 16 | wrongPitch 48 | wrongDuration 28 | wrongOnset 23 | chordMismatch 58
  top error category: Rhythm inference (rhythm-inference)
  top duration error category: too-short (22 sampled)
  top pitch error category: other (24 sampled)
  - Primary: Rhythm inference (rhythm-inference, confidence 0.866)
  - Source scores: rhythm-inference=0.8658, pitch-mapping=0.5772, chord-grouping=0.4176, measure-allocation=0.3633, notehead-detection=0.3029
  - Pitch errors (48): other=24, ±1-accidental=13, ±2-diatonic=11
  - Duration errors (28): too-short=22, onset-coupled=6
  - Detection: chord-grouping=58, extra-notes=25, missing-notes=9
  - Error buckets: chord=58, pitch=48, extra/missing-notes=34, duration=28, onset=23, accidentals=13
  - Largest remaining error bucket: chord = 58 (28%)
  Rhythm/voice attribution (V2 Phase 1):
  - chord-grouping-symptom: 29
  - pitch-grouping-symptom: 29
  - onset-phase-shift: 23
  - onset-coupled-duration: 6
  - chord symptom coupled share: 100%
  Written vs sounding duration (V2 Phase 3):
  - written-duration-wrong: 16
  - onset-coupled-duration: 6
  - serialization-artifact: 6
  - Dominant: written-duration-wrong (16)
  - Hotspot duration traces:
    ...
    - m8: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=2)
  Tie/sustain constraints (V2 Phase 4):
  - expected-cross-measure-tie: 12
  - sounding-release-too-short: 12
  - written-correct-sustain-wrong: 7
  - Dominant: expected-cross-measure-tie (12)
  - Tie glyphs: detected 0, applied 0, slur-like rejected 0, unresolved 0
  Pipeline attribution: voice-serialization
  - voice-serialization: 58 (58 chord/voice grouping mismatch(es))
  - onset-rhythm-inference: 51 (28 duration; 23 onset error(s))
  - pitch-inference: 48 (48 wrong pitch match(es))
  - symbol-detection: 34 (9 missing; 25 extra note(s))
  - tie-repeat-handling: 1 (0 tie candidate(s); 0 applied)
  - measure hotspots: m5 voice-serialization (38), m7 onset-rhythm-inference (38), m6 pitch-inference (36), m4 onset-rhythm-inference (35), m8 pitch-inference (34), m2 symbol-detection (32), m3 pitch-inference (30), m1 voice-serialization (24)
...
- Runtime vs shadow: wrongOnset 23 → 23 (Δ 0), wrongDuration 28 → 28 (Δ 0), chord 58 → 58 (Δ 0)
- Rejected candidates: m1:chord-split, m2:chord-split, m3:chord-split, m4:chord-split, m5:chord-split
...
- Rejected measures: m1:constraints-failed, m2:constraints-failed, m3:constraints-failed, m4:constraints-failed, m5:constraints-failed, m6:constraints-failed, m7:constraints-failed, m8:constraints-failed
  ScoreGraph IR (observation): 124 nodes, 229 edges across 8 measures; geometry bridge n/a
  IR voice budget: 0 overflow measure(s), 0 overflow event(s), 0 underfill measure(s)
  IR duration split: 1 node(s) sounding≠written; 45 tie; 0 gap-to-next
  IR ↔ runtime parity: noteheads ok, rests ok
- reasons: pitchAccuracy: 0.2981 (need ≥0.3153); onsetAccuracy: 0.5385 (need ≥0.6126); chordGroupingAccuracy: 0.536 (need ≥0.6048)
...
- chord: 58
- pitch: 48
- extra/missing-notes: 34
- duration: 28
- onset: 23
- accidentals: 13
- **Largest remaining error bucket: chord = 58 (28% of counted errors)**
