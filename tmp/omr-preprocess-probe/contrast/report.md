...
Generated: 2026-07-17T01:57:36.999Z
Fixtures: 1
Overall: FAIL
Largest remaining error bucket: chord = 52 (27%)
...
- Categories: scanned-score, grand-staff, ties-slurs-articulations, chords-multiple-voices
  pitch 30% | duration 46% | onset 58% | chord 58% | F1 80%
  measureΔ 0 | noteΔ 22 | wrongPitch 46 | wrongDuration 28 | wrongOnset 15 | chordMismatch 52
  top error category: Rhythm inference (rhythm-inference)
  top duration error category: too-short (24 sampled)
  top pitch error category: other (22 sampled)
  - Primary: Rhythm inference (rhythm-inference, confidence 0.866)
  - Source scores: rhythm-inference=0.8658, pitch-mapping=0.5532, chord-grouping=0.3744, notehead-detection=0.36, measure-allocation=0.3482
  - Pitch errors (46): other=22, ±1-accidental=13, ±2-diatonic=11
  - Duration errors (28): too-short=24, onset-coupled=4
  - Detection: chord-grouping=52, extra-notes=31, missing-notes=9
  - Error buckets: chord=52, pitch=46, extra/missing-notes=40, duration=28, onset=15, accidentals=13
  - Largest remaining error bucket: chord = 52 (27%)
  Rhythm/voice attribution (V2 Phase 1):
  - chord-grouping-symptom: 27
  ...
  - written-duration-wrong: 20
  - onset-coupled-duration: 4
  - serialization-artifact: 4
  - Dominant: written-duration-wrong (20)
  ...
  - written-correct-sustain-wrong: 10
  ...
  - voice-serialization: 52 (52 chord/voice grouping mismatch(es))
  - pitch-inference: 46 (46 wrong pitch match(es))
  - onset-rhythm-inference: 43 (28 duration; 15 onset error(s))
  - symbol-detection: 40 (9 missing; 31 extra note(s))
  - tie-repeat-handling: 1 (0 tie candidate(s); 0 applied)
  - measure hotspots: m7 voice-serialization (39), m6 pitch-inference (36), m2 symbol-detection (34), m4 onset-rhythm-inference (33), m8 pitch-inference (32), m3 pitch-inference (30), m5 pitch-inference (29), m1 voice-serialization (24)
...
- Runtime vs shadow: wrongOnset 15 → 15 (Δ 0), wrongDuration 28 → 28 (Δ 0), chord 52 → 52 (Δ 0)
...
- Rejected measures: m1:constraints-failed, m2:constraints-failed, m3:constraints-failed, m4:constraints-failed, m5:constraints-failed, m6:constraints-failed, m7:constraints-failed, m8:constraints-failed
  ScoreGraph IR (observation): 124 nodes, 240 edges across 8 measures; geometry bridge n/a
...
- reasons: pitchAccuracy: 0.3 (need ≥0.3153); durationAccuracy: 0.4636 (need ≥0.4685); onsetAccuracy: 0.5818 (need ≥0.6126); chordGroupingAccuracy: 0.584 (need ≥0.6048); noteDetectionF1: 0.798 (need ≥0.804)
...
- chord: 52
- pitch: 46
- extra/missing-notes: 40
- duration: 28
- onset: 15
- accidentals: 13
- **Largest remaining error bucket: chord = 52 (27% of counted errors)**
