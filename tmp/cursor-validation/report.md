...
Generated: 2026-07-17T17:07:46.554Z
Fixtures: 22
Overall: PASS
Largest remaining error bucket: chord = 8930 (31%)
...
- Rejected measures: m1:constraints-failed, m2:constraints-failed, m3:constraints-failed, m4:constraints-failed, m5:constraints-failed, m6:constraints-failed, m7:constraints-failed, m8:constraints-failed
  ScoreGraph IR (observation): 199 nodes, 432 edges across 8 measures; geometry bridge 100%
  IR voice budget: 0 overflow measure(s), 0 overflow event(s), 0 underfill measure(s)
...
### Twinkle 1880 decorative cover (negative-page isolation) (`pass`)
- PDF: `/Users/ryland/Documents/scoreflow/benchmarks/omr-stress/twinkle-1880-loc/twinkle-1880-loc-cover.pdf`
- License: Public-Domain (real-pd-scan-twinkle-1880-cover)
- Categories: decorative-cover, negative-page, historical-scan, public-domain, real-world-score
- Expected honest rejection: no-systems
- reasons: no-systems
- error: PDF too difficult for local generation. Try a cleaner digital export or upload MusicXML/MXL.

### Twinkle 1880 music page 2 (import observation) (`skipped`)
- PDF: `/Users/ryland/Documents/scoreflow/benchmarks/omr-stress/twinkle-1880-loc/twinkle-1880-loc-music-p2.pdf`
- License: Public-Domain (real-pd-scan-twinkle-1880-music)
- Categories: piano-grand-staff, historical-scan, page-noise, public-domain, real-world-score
- Import observation: rejected
- reasons: low-confidence
- error: PDF too difficult for local generation. Try a cleaner digital export or upload MusicXML/MXL.
...
- Truth: `/Users/ryland/Downloads/la-campanella-grandes-etudes-de-paganini-no-3-franz-liszt.mxl`
  ...
  measureΔ 10 | noteΔ -286 | wrongPitch 2168 | wrongDuration 384 | wrongOnset 1532 | chordMismatch 2690
  top error category: Rhythm inference (rhythm-inference)
  top duration error category: beamed-subdivision (296 sampled)
  top pitch error category: other (1421 sampled)
  - Primary: Rhythm inference (rhythm-inference, confidence 0.891)
  - Source scores: rhythm-inference=0.8906, pitch-mapping=0.6345, measure-allocation=0.5688, chord-grouping=0.4341, notehead-detection=0.3002
  - Pitch errors (2168): other=1421, ±1-accidental=279, ±octave=259, ±2-diatonic=200, ±octave-other=9
  - Duration errors (384): beamed-subdivision=296, onset-coupled=80, too-short=8
  - Detection: chord-grouping=2690, missing-notes=1129, extra-notes=843
  - Error buckets: chord=2690, pitch=2168, extra/missing-notes=1972, onset=1532, slurs=1009, duration=384, ties=340, rests=285, accidentals=279
  - Largest remaining error bucket: chord = 2690 (25%)
  Rhythm/voice attribution (V2 Phase 1):
  - pitch-grouping-symptom: 1869
  - chord-grouping-symptom: 1631
  - onset-phase-shift: 1282
  - voice-serialization-shift: 266
  - onset-coupled-duration: 80
  - chord symptom coupled share: 100%
  Written vs sounding duration (V2 Phase 3):
  ...
  Tie/sustain constraints (V2 Phase 4):
  - slur-like-arc-pitch-differs: 340
  - tie-start-without-continuation: 130
  - continuation-without-tie-start: 43
  - written-correct-sustain-wrong: 37
  - expected-cross-measure-tie: 1
  - sounding-release-too-short: 1
  - Dominant: slur-like-arc-pitch-differs (340)
  - Tie glyphs: detected 359, applied 19, slur-like rejected 340, unresolved 0
  Pipeline attribution: voice-serialization
  - voice-serialization: 2690 (2690 chord/voice grouping mismatch(es))
  - pitch-inference: 2168 (2168 wrong pitch match(es))
  - symbol-detection: 1972 (1129 missing; 843 extra note(s))
  - onset-rhythm-inference: 1916 (384 duration; 1532 onset error(s))
  - measure-barline-segmentation: 14 (measure count 160/150 (Δ10); 4 irregular system grid(s))
  - measure hotspots: m87 voice-serialization (171), m79 voice-serialization (159), m101 voice-serialization (156), m134 pitch-inference (149), m137 symbol-detection (147), m139 onset-rhythm-inference (134), m68 voice-serialization (132), m136 pitch-inference (132)
...
- Shadow XML identical to runtime (no qualifying measures)
- Runtime vs shadow: wrongOnset 1532 → 1532 (Δ 0), wrongDuration 384 → 384 (Δ 0), chord 2690 → 2690 (Δ 0)
...
- Constraints: **phase-7-duration-coupled**
- Note: No measures passed Phase 6 preservation + truth gates — shadow identical to runtime.
- Solver: 2 structurally applied (2 duration-coupled) / 0 truth-approved / 139 candidates
- Shadow XML identical to runtime (no qualifying measures)
- Runtime vs shadow: wrongOnset 1532 → 1532 (Δ 0), wrongDuration 384 → 384 (Δ 0), chord 2690 → 2690 (Δ 0)
- Rejected measures: m1:constraints-failed, m2:constraints-failed, m3:constraints-failed, m6:constraints-failed, m7:constraints-failed, m9:constraints-failed, m10:constraints-failed, m11:constraints-failed…
  ScoreGraph IR (observation): 9086 nodes, 17185 edges across 160 measures; geometry bridge 100%
  IR voice budget: 0 overflow measure(s), 0 overflow event(s), 4 underfill measure(s)
  IR duration split: 72 node(s) sounding≠written; 1868 tie; 68 gap-to-next
  IR ↔ runtime parity: noteheads ok, rests ok
...
- Truth: `/Users/ryland/Downloads/etude-s-1413-in-g-minor-la-campanella-liszt.mxl`
  pitch 11% | duration 29% | onset 19% | chord 20% | F1 39%
  measureΔ 71 | noteΔ -399 | wrongPitch 1122 | wrongDuration 359 | wrongOnset 760 | chordMismatch 5389
  top error category: Measure allocation (measure-allocation)
  top duration error category: beamed-subdivision (283 sampled)
  top pitch error category: other (727 sampled)
  - Primary: Measure allocation (measure-allocation, confidence 1)
  - Source scores: measure-allocation=1, rhythm-inference=0.884, notehead-detection=0.7171, chord-grouping=0.7166, pitch-mapping=0.6755
  - Pitch errors (1122): other=727, ±2-diatonic=159, ±1-accidental=157, ±octave=74, ±octave-other=5
  - Duration errors (359): beamed-subdivision=283, onset-coupled=73, too-long=2, too-short=1
  - Detection: chord-grouping=5389, missing-notes=2695, extra-notes=2296
  - Error buckets: chord=5389, extra/missing-notes=4991, pitch=1122, slurs=953, onset=760, duration=359, rests=303, ties=173, accidentals=157
  - Largest remaining error bucket: chord = 5389 (38%)
  Rhythm/voice attribution (V2 Phase 1):
  - chord-grouping-symptom: 2446
  - pitch-grouping-symptom: 1009
  - onset-phase-shift: 665
  - voice-serialization-shift: 119
  - onset-coupled-duration: 73
  - chord symptom coupled share: 100%
  Written vs sounding duration (V2 Phase 3):
  - serialization-artifact: 150
  - written-duration-wrong: 136
  - onset-coupled-duration: 73
  - Dominant: serialization-artifact (150)
  - Hotspot duration traces:
    ...
    - m21: 6 wrong durations (written-duration-wrong=2, onset-coupled-duration=4)
    ...
    - m47: 2 wrong durations (serialization-artifact=2)
    - m48: 2 wrong durations (written-duration-wrong=2)
    - m49: 2 wrong durations (written-duration-wrong=2)
    - m50: 8 wrong durations (written-duration-wrong=4, serialization-artifact=4)
    - m51: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=1)
    - m52: 6 wrong durations (written-duration-wrong=2, onset-coupled-duration=1, serialization-artifact=3)
    - m53: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=1)
    - m54: 10 wrong durations (written-duration-wrong=4, onset-coupled-duration=1, serialization-artifact=5)
    - m56: 4 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=2)
    - m57: 4 wrong durations (serialization-artifact=4)
    - m58: 3 wrong durations (serialization-artifact=3)
    - m59: 1 wrong durations (serialization-artifact=1)
    - m60: 4 wrong durations (serialization-artifact=4)
    - m61: 3 wrong durations (onset-coupled-duration=1, serialization-artifact=2)
    - m67: 4 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=2)
    - m68: 6 wrong durations (written-duration-wrong=4, onset-coupled-duration=2)
    - m69: 9 wrong durations (written-duration-wrong=6, serialization-artifact=3)
    - m70: 5 wrong durations (onset-coupled-duration=1, serialization-artifact=4)
    - m72: 4 wrong durations (written-duration-wrong=2, onset-coupled-duration=1, serialization-artifact=1)
    - m73: 2 wrong durations (written-duration-wrong=2)
    - m74: 8 wrong durations (written-duration-wrong=3, onset-coupled-duration=1, serialization-artifact=4)
    - m75: 3 wrong durations (onset-coupled-duration=1, serialization-artifact=2)
    ...
    - m79: 2 wrong durations (written-duration-wrong=2)
    - m80: 8 wrong durations (written-duration-wrong=5, serialization-artifact=3)
    - m81: 1 wrong durations (serialization-artifact=1)
    - m82: 2 wrong durations (written-duration-wrong=1, serialization-artifact=1)
    - m83: 1 wrong durations (written-duration-wrong=1)
    - m84: 1 wrong durations (written-duration-wrong=1)
    - m85: 7 wrong durations (written-duration-wrong=7)
    - m86: 6 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=4)
    - m87: 3 wrong durations (written-duration-wrong=1, serialization-artifact=2)
    - m88: 2 wrong durations (written-duration-wrong=1, serialization-artifact=1)
    - m90: 2 wrong durations (onset-coupled-duration=1, serialization-artifact=1)
    - m91: 4 wrong durations (written-duration-wrong=1, onset-coupled-duration=2, serialization-artifact=1)
    - m92: 3 wrong durations (written-duration-wrong=2, serialization-artifact=1)
    - m93: 4 wrong durations (written-duration-wrong=3, serialization-artifact=1)
    - m94: 2 wrong durations (written-duration-wrong=1, serialization-artifact=1)
    - m95: 5 wrong durations (onset-coupled-duration=2, serialization-artifact=3)
    - m97: 4 wrong durations (written-duration-wrong=1, onset-coupled-duration=2, serialization-artifact=1)
    - m98: 2 wrong durations (written-duration-wrong=1, serialization-artifact=1)
    - m99: 5 wrong durations (written-duration-wrong=2, onset-coupled-duration=1, serialization-artifact=2)
    - m100: 1 wrong durations (onset-coupled-duration=1)
    - m101: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=1)
    - m103: 2 wrong durations (serialization-artifact=2)
    - m104: 3 wrong durations (serialization-artifact=3)
    - m105: 4 wrong durations (written-duration-wrong=1, serialization-artifact=3)
    - m106: 5 wrong durations (written-duration-wrong=2, serialization-artifact=3)
    - m107: 3 wrong durations (written-duration-wrong=1, serialization-artifact=2)
    - m109: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=2)
    - m110: 1 wrong durations (written-duration-wrong=1)
    - m112: 2 wrong durations (onset-coupled-duration=1, serialization-artifact=1)
    - m113: 1 wrong durations (written-duration-wrong=1)
    - m114: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=1)
    - m115: 5 wrong durations (written-duration-wrong=2, onset-coupled-duration=1, serialization-artifact=2)
    - m116: 3 wrong durations (written-duration-wrong=2, serialization-artifact=1)
    - m117: 3 wrong durations (onset-coupled-duration=1, serialization-artifact=2)
    - m118: 1 wrong durations (serialization-artifact=1)
    - m120: 1 wrong durations (written-duration-wrong=1)
    - m121: 1 wrong durations (written-duration-wrong=1)
    - m122: 2 wrong durations (written-duration-wrong=1, onset-coupled-duration=1)
    - m125: 1 wrong durations (onset-coupled-duration=1)
    - m126: 1 wrong durations (written-duration-wrong=1)
    - m127: 4 wrong durations (serialization-artifact=4)
    - m128: 1 wrong durations (onset-coupled-duration=1)
    - m129: 1 wrong durations (written-duration-wrong=1)
    - m130: 2 wrong durations (written-duration-wrong=2)
    - m135: 1 wrong durations (serialization-artifact=1)
    - m137: 1 wrong durations (onset-coupled-duration=1)
    - m138: 3 wrong durations (written-duration-wrong=1, onset-coupled-duration=1, serialization-artifact=1)
  Tie/sustain constraints (V2 Phase 4):
  - slur-like-arc-pitch-differs: 173
  - tie-start-without-continuation: 98
  - written-correct-sustain-wrong: 22
  - continuation-without-tie-start: 20
  - Dominant: slur-like-arc-pitch-differs (173)
  - Tie glyphs: detected 238, applied 65, slur-like rejected 173, unresolved 0
  Pipeline attribution: voice-serialization
  - voice-serialization: 5389 (5389 chord/voice grouping mismatch(es))
  - symbol-detection: 4991 (2695 missing; 2296 extra note(s))
  - pitch-inference: 1122 (1122 wrong pitch match(es))
  - onset-rhythm-inference: 1119 (359 duration; 760 onset error(s))
  - measure-barline-segmentation: 90 (measure count 217/146 (Δ71); 19 irregular system grid(s))
  - measure hotspots: m77 symbol-detection (289), m135 voice-serialization (163), m137 voice-serialization (141), m127 symbol-detection (134), m203 measure-barline-segmentation (128), m61 voice-serialization (117), m95 symbol-detection (116), m117 pitch-inference (113)
...
- Constraints: **phase-2c**
- Note: No measures passed Phase 2C preservation + truth gates — shadow identical to runtime.
- Solver: 0 accepted / 184 candidates / 184 rejected
- Shadow XML identical to runtime (no qualifying measures)
- Runtime vs shadow: wrongOnset 760 → 760 (Δ 0), wrongDuration 359 → 359 (Δ 0), chord 5389 → 5389 (Δ 0)
...
- Promoted: **no**
- Constraints: **phase-7-duration-coupled**
- Note: Shadow voice serialization solver regressed chord and/or duration — kept diagnostic-only.
- Solver: 7 structurally applied (7 duration-coupled) / 1 truth-approved / 143 candidates
- Runtime vs shadow: wrongOnset 760 → 760 (Δ 0), wrongDuration 359 → 353 (Δ -6), chord 5389 → 5395 (Δ 6)
- Accepted measures: m87:accompaniment-adaptive-phase-coupled
- Rejected measures: m1:constraints-failed, m2:constraints-failed, m3:constraints-failed, m5:constraints-failed, m6:constraints-failed, m7:constraints-failed, m8:constraints-failed, m9:no-improvement…
  ScoreGraph IR (observation): 8508 nodes, 16118 edges across 217 measures; geometry bridge 100%
  IR voice budget: 0 overflow measure(s), 0 overflow event(s), 14 underfill measure(s)
  IR duration split: 73 node(s) sounding≠written; 1883 tie; 51 gap-to-next
  IR ↔ runtime parity: noteheads ok, rests ok
...
- ties: 581
- accidentals: 525
- **Largest remaining error bucket: chord = 8930 (31% of counted errors)**
...
- real-public-domain-piano-scan: 3 fixture(s) (skipped=2, pass=1)
