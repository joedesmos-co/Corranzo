...
- Commit: `beeb5f0`
- Created: 2026-08-03T12:20:45.692Z
...
|---|---:|
| Chord events | 20 |
| Exact pitch-set matches | 6 |
| Exact chord accuracy | **30%** |
| Incorrect chords | 14 |
| Missing tones | 14 |
| Extra tones | 14 |
| Incorrect pitches (matched+unmatched defects) | 28 |
| Octave errors | 0 |
| Wrong-staff errors | 0 |
| Near diatonic step misses (±1–2 semitone unpaired) | 14 |
...
| high-normal | 94 | 48.94% | 48 | 69 | 86 | 0 | 0 |
| high-extreme | 20 | 30% | 14 | 14 | 14 | 0 | 0 |
...
|---|---:|---:|
| `self-calibrated-glyph-fallback` | 34 | 23 |
| `ink-notehead-geometry` | 6 | 5 |
| `ledger-masked-ink-notehead-geometry` | 5 | 4 |
...
|---|---:|
| ledger_line_ownership_or_pitch_anchor | 13 |
| none | 6 |
| pitch_mapping | 1 |
...
| 2 | piano-dense-advanced-vector | 6 | 1/1 | C#5 F5 G#5 → C#5 F#5 G#5 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback, ledger-masked-ink-notehead-geometry, ink-notehead-geometry |
...
| 5 | piano-dense-advanced-vector | 6 | 1/1 | C#5 F5 G#5 → C#5 F#5 G#5 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback, ledger-masked-ink-notehead-geometry, ink-notehead-geometry |
...
| 11 | piano-dense-advanced-vector | 7 | 1/1 | C#5 F5 G#5 → C#5 F#5 G#5 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback, ink-notehead-geometry |
| 12 | piano-dense-advanced-vector | 8 | 1/1 | F5 A5 C6 → F#5 A5 C6 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback |
| 13 | piano-dense-advanced-vector | 8 | 1/1 | G5 B5 D6 → G#5 B5 D6 | G5 | G#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback |
| 14 | piano-dense-advanced-vector | 8 | 1/1 | F5 A5 C6 → F#5 A5 C6 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback |
