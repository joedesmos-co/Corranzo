...
- Commit: `beeb5f0`
- Created: 2026-08-03T12:22:35.193Z
...
|---|---:|
| Chord events | 20 |
| Exact pitch-set matches | 7 |
| Exact chord accuracy | **35%** |
| Incorrect chords | 13 |
| Missing tones | 13 |
| Extra tones | 13 |
| Incorrect pitches (matched+unmatched defects) | 26 |
| Octave errors | 0 |
...
| high-normal | 94 | 42.55% | 54 | 76 | 93 | 0 | 0 |
| high-extreme | 20 | 35% | 13 | 13 | 13 | 0 | 0 |

## Anchor method / fallback rates (high-extreme tones)

Ink geometry successes: **5** · Glyph-metrics fallbacks: **1**

| Anchor source / reject reason | Tone touches | On incorrect chords |
|---|---:|---:|
| `self-calibrated-glyph-fallback` | 31 | 16 |
| `ink-notehead-geometry` | 5 | 5 |
...
| 4 | piano-dense-advanced-vector | 6 | 1/1 | E5 G#5 B5 → F5 G#5 B5 | E5 | F5 | pitch_mapping | — |
| 5 | piano-dense-advanced-vector | 6 | 1/1 | D5 F#5 A5 → D#5 F#5 A5 | D5 | D#5 | ledger_line_ownership_or_pitch_anchor | ink-notehead-geometry, ledger-masked-ink-notehead-geometry, glyph-metrics-fallback/ambiguous-components |
| 6 | piano-dense-advanced-vector | 6 | 1/1 | C#5 F5 G#5 → C#5 F#5 G#5 | F5 | F#5 | pitch_mapping | self-calibrated-glyph-fallback, ink-notehead-geometry |
| 7 | piano-dense-advanced-vector | 7 | 1/1 | C#5 F5 G#5 → C#5 F#5 G#5 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback |
...
| 9 | piano-dense-advanced-vector | 7 | 1/1 | D#5 G5 A#5 → D#5 G#5 A#5 | G5 | G#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback |
| 10 | piano-dense-advanced-vector | 7 | 1/1 | C#5 F5 G#5 → C#5 F#5 G#5 | F5 | F#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback, ink-notehead-geometry |
| 11 | piano-dense-advanced-vector | 8 | 1/1 | F5 A5 C6 → F#5 A5 C6 | F5 | F#5 | pitch_mapping | self-calibrated-glyph-fallback |
| 12 | piano-dense-advanced-vector | 8 | 1/1 | G5 B5 D6 → G#5 B5 D6 | G5 | G#5 | ledger_line_ownership_or_pitch_anchor | self-calibrated-glyph-fallback |
| 13 | piano-dense-advanced-vector | 8 | 1/1 | F5 A5 C6 → F#5 A5 C6 | F5 | F#5 | pitch_mapping | self-calibrated-glyph-fallback |
