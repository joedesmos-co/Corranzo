...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| overall | 230 | 42.61% | 132 | 178 | 202 | 380 | 10 | 0 | 0 | 0 |
| low-extreme | 17 | 76.47% | 4 | 6 | 2 | 8 | 0 | 0 | 0 | 0 |
| low-normal | 69 | 65.22% | 24 | 31 | 36 | 67 | 1 | 0 | 0 | 0 |
| middle | 30 | 40% | 18 | 15 | 21 | 36 | 9 | 0 | 0 | 0 |
| high-normal | 94 | 24.47% | 71 | 103 | 122 | 225 | 0 | 0 | 0 | 0 |
| high-extreme | 20 | 25% | 15 | 23 | 21 | 44 | 0 | 0 | 0 | 0 |
...
|---|---:|
| pitch_mapping | 57 |
| chord_column_grouping | 36 |
| notehead_detection_or_pitch_filter | 23 |
| ledger_line_ownership_or_pitch_anchor | 16 |
...
| piano-dense-advanced-vector | 84 | 52 | 0/3 | 15/20 | 4/25 | 33/36 | 0/0 |
...
| 5 | piano-dense-advanced-vector | 6 | 1/1 | high-extreme | E5 G#5 B5 → D#5 G#5 B5 | E5 | D#5 | pitch_mapping |
| 6 | piano-dense-advanced-vector | 6 | 1/1 | high-extreme | C#5 F5 G#5 → C#5 F5 F5 | G#5 | F5 | pitch_mapping |
| 7 | piano-dense-advanced-vector | 6 | 1/1 | high-extreme | D5 F#5 A5 → C#5 F5 F#5 | D5 A5 | C#5 F5 | pitch_mapping |
| 8 | piano-dense-advanced-vector | 6 | 1/1 | high-extreme | D5 F#5 A5 → C#5 F#5 | D5 A5 | C#5 | notehead_detection_or_pitch_filter |
| 9 | piano-dense-advanced-vector | 7 | 1/1 | high-extreme | C#5 F5 G#5 → C#5 F5 F#5 | G#5 | F#5 | pitch_mapping |
| 10 | piano-dense-advanced-vector | 7 | 1/1 | high-extreme | D#5 G5 A#5 → D#5 F#5 A#5 | G5 | F#5 | pitch_mapping |
| 11 | piano-dense-advanced-vector | 7 | 1/1 | high-extreme | E5 G#5 B5 → C#5 F5 G#5 | E5 B5 | C#5 F5 | ledger_line_ownership_or_pitch_anchor |
| 12 | piano-dense-advanced-vector | 7 | 1/1 | high-extreme | E5 G#5 B5 → F#5 G#5 | E5 B5 | F#5 | notehead_detection_or_pitch_filter |
| 13 | piano-dense-advanced-vector | 7 | 1/1 | high-extreme | D#5 G5 A#5 → C#5 D#5 F#5 | G5 A#5 | C#5 F#5 | pitch_mapping |
| 14 | piano-dense-advanced-vector | 8 | 1/1 | high-extreme | D5 F#5 A5 → D5 F#5 A#5 | A5 | A#5 | ledger_line_ownership_or_pitch_anchor |
| 15 | piano-dense-advanced-vector | 8 | 1/1 | high-extreme | E5 G#5 B5 → D5 F#5 B5 | E5 G#5 | D5 F#5 | ledger_line_ownership_or_pitch_anchor |
| 16 | piano-dense-advanced-vector | 8 | 1/1 | high-extreme | F5 A5 C6 → F#5 C6 | F5 A5 | F#5 | notehead_detection_or_pitch_filter |
| 17 | piano-dense-advanced-vector | 8 | 1/1 | high-extreme | G5 B5 D6 → G5 A#5 D6 | B5 | A#5 | ledger_line_ownership_or_pitch_anchor |
| 18 | piano-dense-advanced-vector | 8 | 1/1 | high-extreme | F5 A5 C6 → D5 F#5 C6 | F5 A5 | D5 F#5 | pitch_mapping |
| 19 | piano-dense-advanced-vector | 8 | 1/1 | high-extreme | D5 F#5 A5 → D5 E5 F#5 A#5 | A5 | E5 A#5 | chord_column_grouping |
