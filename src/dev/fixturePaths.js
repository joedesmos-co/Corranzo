...
export const PRACTICE_LIBRARY_FIXTURES = [
  practiceFixture({
    ...
    teaches: 'Minuet pulse and two-hand balance',
    measureCount: 32,
  ...
  practiceFixture({
    ...
    teaches: 'Dense reading and phrase flow',
    paths: FIXTURE_PATHS,
  ...
  practiceFixture({
    ...
    teaches: 'First-position melody and TAB',
  ...
  practiceFixture({
    ...
    difficulty: 'Beginner',
    approxDuration: '45s',
    teaches: 'Slow phrasing, open position',
    measureCount: 4,
  }),
  practiceFixture({
